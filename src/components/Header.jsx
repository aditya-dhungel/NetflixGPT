...
import { GPT_ICON, LOGO, SUPPORTED_LANGUAGES } from "../utils/constants";
    ...
    <div className="absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-10 flex justify-between">
      ...
      {user && (
        <div className="flex p-2">
          {showGptSearch && (
            <select
              className="p-2 my-5 bg-gray-600 text-white rounded-xl"
          ...
          >
            ...
            <img
              className="w-8 h-8 object-contain transition-transform duration-500 group-hover:rotate-[360deg]"
              src={GPT_ICON}
              alt="GPT icon"
            />
          </button>
