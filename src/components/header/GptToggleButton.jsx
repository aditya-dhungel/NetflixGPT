...
const GptToggleButton = () => {
  ...
  return (
    <button
      ...
      className="text-sm md:text-md md:px-4 px-3 py-2 m-4 h-8 md:h-10 md:mt-4 -translate-y-1 md:translate-y-0 flex items-center justify-center gap-1.5 font-semibold text-white
    ...
    >
      ...
      ${
        showGptSearch
          ? "w-4 md:w-5 h-4 md:h-5 hidden md:block"
